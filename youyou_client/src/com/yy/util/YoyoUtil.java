...
public class YoyoUtil {
	...
	public String returnOrderNumb() {
		...
		String charString = new YoyoUtil().generateString(5);
	...
	private static String getXmlInfo(String payClass, String payMoney, String orderNumb, String orderTime, String openid, String ipString) throws Exception {  
        ...
        String nonce_str = new YoyoUtil().generateString(24);
        String sign = new YoyoUtil().returnSign(nonce_str, body+payClass, orderNumb, openid, payMoney, orderTime, trade_type, ipString);
        sb.append("<xml>");  
