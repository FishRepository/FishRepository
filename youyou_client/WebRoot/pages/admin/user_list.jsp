		...
		$(document).ready(function(){
			...
			$.ajax({
	    		...
	    		console.log(d)
	    			if(d.RESULT=="SUCCESS"){
	    				var tr = "";
	    				topics_length = d.USER_LENGTH;
	    				$(".tt_page").text(Math.ceil(d.USER_LENGTH/10))
	    				$(".topic_num").text(d.USER_LENGTH);
	    				for(var i=0;i<d.LIST.length;i++){
	    					tr+="<tr><td>"+d.LIST[i].nick_name+"</td><td>"+sex[d.LIST[i].sex]+"</td><td>"+d.LIST[i].phone_number+"</td><td>"+d.LIST[i].province+"</td><td>"+d.LIST[i].city+"</td></tr>"
	    				}
	    				$(".topic_tab").html(tr);
	    			}
	    		}
